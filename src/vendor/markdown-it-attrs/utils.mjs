 ...
 */
export function getAttrs(str, start, options) {
 ...
 */
export function addAttrs(attrs, token) {
 ...
 */
export function hasDelimiters(where, options) {
  if (!where) {
 ...
 */
export function removeDelimiter(str, options) {
 ...
 */
export function getMatchingOpeningToken(tokens, i) {
