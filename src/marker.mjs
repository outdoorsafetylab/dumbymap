/**
 * @module marker
 * @description Predefined SVG map marker icon definitions.
 * Each named export is a {@link MarkerDef} consumed by {@link getMarkersFromMaps}.
 */

/**
 * @typedef {Object} MarkerDef
 * @property {string}   html    - Inline SVG markup for the marker icon
 * @property {number[]} size    - [width, height] in pixels
 * @property {number[]} anchor  - [x, y] pixel offset of the tip/centre from top-left
 * @property {number}  [order]  - Sort position in the marker-picker UI (lower = earlier)
 * @property {string}  [name]   - Human-readable label; falls back to the capitalised export key
 */

/** @type {MarkerDef} Drop-pin with shadow (MapLibre default style) */
export const pin = {
  order: 1,
...
/** @type {MarkerDef} Small red filled circle */
export const circle = {
  order: 2,
...
/** @type {MarkerDef} Water / drinking-water point */
export const water = {
...
/** @type {MarkerDef} Campsite / tent icon */
...
/** @type {MarkerDef} Caution / warning triangle with exclamation mark */
...
/** @type {MarkerDef} Communication tower / antenna */
...
/** @type {MarkerDef} Cross / × symbol (delete / closed) */
export const cross = {
...
/** @type {MarkerDef} Construction / road work cone */
...
/** @type {MarkerDef} Danger / hazardous-area skull-like icon */
export const danger = {
...
/** @type {MarkerDef} Fence / barrier line icon */
export const fence = {
...
/** @type {MarkerDef} Heliport / helicopter landing pad */
...
/** @type {MarkerDef} Hot spring / onsen symbol */
...
/** @type {MarkerDef} Mountain / peak triangle */
...
/** @type {MarkerDef} Parking / P symbol */
...
/** @type {MarkerDef} Rail / train station icon */
export const rail = {
...
/** @type {MarkerDef} Racetrack / circuit flag icon */
...
/** @type {MarkerDef} Road block / no-entry circle */
...
/** @type {MarkerDef} Star / favourite point of interest */
export const star = {
...
/** @type {MarkerDef} Animal / wildlife sighting point */
export const animal = {
...
/** @type {MarkerDef} Filled black triangle (general purpose) */
...
/** @type {MarkerDef} Outlined / hollow triangle (survey benchmark style) */
